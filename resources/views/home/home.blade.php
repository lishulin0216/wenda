        ...
        <div class="search-area container input-group-lg">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active">
                        <img style="width:1140px;height:286px;" src="{{asset('images/four.jpg')}}" alt="First slide">
                    </div>
                    <div class="item">
                        <img style="width:1140px;height:286px;" src="{{asset('images/two.jpg')}}" alt="Second slide">
                    </div>
                    <div class="item">
                        <img style="width:1140px;height:286px;" src="{{asset('images/one.jpg')}}" alt="Third slide">
                    </div>
                <!-- 轮播（Carousel）导航 -->
